...
abstract class FocusTraversalPolicy extends _DiagnosticableTree&Object&Diagnosticable {
  ...
  static _ _findGroups(/* No info */) {
    ...
    //     0x2e1f60: ldr             x0, [PP, #0x6aa0]  ; [pp+0x6aa0] Closure: (FocusNode, {ScrollPositionAlignmentPolicy? alignmentPolicy, double? alignment, Duration? duration, Curve? curve}) => void from Function 'defaultTraversalRequestFocusCallback': static. (0x7f3fd62423b8)
    ...
    //     0x2e22ec: ldr             x2, [PP, #0x5078]  ; [pp+0x5078] Closure: (FocusNode) => bool from Function '_allowDescendantsToBeFocused@99042876': static. (0x7f3fd6249818)
    // 0x2e22f0: r0 = every()
...
class FocusTraversalGroup extends StatefulWidget {
  ...
  _ FocusTraversalGroup(/* No info */) {
    ...
    //     0x1df4e8: ldr             x1, [PP, #0x6aa0]  ; [pp+0x6aa0] Closure: (FocusNode, {ScrollPositionAlignmentPolicy? alignmentPolicy, double? alignment, Duration? duration, Curve? curve}) => void from Function 'defaultTraversalRequestFocusCallback': static. (0x7f3fd62423b8)
