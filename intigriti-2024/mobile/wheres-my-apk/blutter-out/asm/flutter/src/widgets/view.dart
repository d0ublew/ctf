...
class _ViewState extends __ViewState&State&WidgetsBindingObserver {
  ...
  _ _ViewState(/* No info */) {
    ...
    //     0x243638: ldr             x1, [PP, #0x6aa0]  ; [pp+0x6aa0] Closure: (FocusNode, {ScrollPositionAlignmentPolicy? alignmentPolicy, double? alignment, Duration? duration, Curve? curve}) => void from Function 'defaultTraversalRequestFocusCallback': static. (0x7f3fd62423b8)
