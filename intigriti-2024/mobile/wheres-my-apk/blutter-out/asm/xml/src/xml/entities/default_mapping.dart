...
class XmlDefaultEntityMapping extends XmlEntityMapping {
  ...
  _ encodeAttributeValue(/* No info */) {
    ...
    //     0x2cad58: add             x3, PP, #0x11, lsl #12  ; [pp+0x11bb8] Closure: (Match) => String from Function '_singeQuoteAttributeReplace@430209047': static. (0x7f3fd6324080)
    ...
    //     0x2cad98: add             x3, PP, #0x11, lsl #12  ; [pp+0x11bc8] Closure: (Match) => String from Function '_doubleQuoteAttributeReplace@430209047': static. (0x7f3fd6323db8)
  ...
  _ encodeText(/* No info */) {
    ...
    //     0x2cb6bc: add             x3, PP, #0x11, lsl #12  ; [pp+0x11b60] Closure: (Match) => String from Function '_textReplace@430209047': static. (0x7f3fd63246dc)
