...
class :: {
  ...
  static Future<Y1> compute<Y0, Y1>((dynamic, Y0) => FutureOr<Y1>, Y0, {String? debugLabel}) async {
    ...
    //     0x282870: add             x9, PP, #9, lsl #12  ; [pp+0x92f0] Closure: <Y0, Y1>(_IsolateConfiguration<Y0, Y1>) => Future<void> from Function '_spawn@305363018': static. (0x7fa9a794d3a8)
    ...
    //     0x2828b0: add             x16, PP, #9, lsl #12  ; [pp+0x92f0] Closure: <Y0, Y1>(_IsolateConfiguration<Y0, Y1>) => Future<void> from Function '_spawn@305363018': static. (0x7fa9a794d3a8)
    ...
    //     0x2828e8: add             x0, PP, #9, lsl #12  ; [pp+0x92f0] Closure: <Y0, Y1>(_IsolateConfiguration<Y0, Y1>) => Future<void> from Function '_spawn@305363018': static. (0x7fa9a794d3a8)
