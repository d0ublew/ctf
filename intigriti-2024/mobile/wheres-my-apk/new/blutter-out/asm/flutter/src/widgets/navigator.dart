...
abstract class Route<X0> extends _RoutePlaceholder {
  ...
  get _ isFirst(/* No info */) {
    ...
    //     0x1e4ff8: ldr             x2, [PP, #0x7af0]  ; [pp+0x7af0] Closure: (_RouteEntry) => bool from Function 'isPresentPredicate': static. (0x7fa9a78b2ea8)
...
class NavigatorState extends _NavigatorState&State&TickerProviderStateMixin&RestorationMixin {
  ...
  _ _flushHistoryUpdates(/* No info */) {
    ...
    //     0x1e15a4: ldr             x3, [PP, #0x7af0]  ; [pp+0x7af0] Closure: (_RouteEntry) => bool from Function 'isPresentPredicate': static. (0x7fa9a78b2ea8)
    ...
    //     0x1e17b8: ldr             x3, [PP, #0x7af0]  ; [pp+0x7af0] Closure: (_RouteEntry) => bool from Function 'isPresentPredicate': static. (0x7fa9a78b2ea8)
    ...
    //     0x1e18ec: ldr             x3, [PP, #0x7b08]  ; [pp+0x7b08] Closure: (_RouteEntry) => bool from Function 'willBePresentPredicate': static. (0x7fa9a78b2e70)
    ...
    //     0x1e19b0: ldr             x3, [PP, #0x7b08]  ; [pp+0x7b08] Closure: (_RouteEntry) => bool from Function 'willBePresentPredicate': static. (0x7fa9a78b2e70)
    ...
    //     0x1e1b54: ldr             x3, [PP, #0x7b08]  ; [pp+0x7b08] Closure: (_RouteEntry) => bool from Function 'willBePresentPredicate': static. (0x7fa9a78b2e70)
  ...
  _ _flushRouteAnnouncement(/* No info */) {
    ...
    //     0x1e3f30: ldr             x3, [PP, #0x7c60]  ; [pp+0x7c60] Closure: (_RouteEntry) => bool from Function 'suitableForTransitionAnimationPredicate': static. (0x7fa9a78ae268)
  ...
  _ canPop(/* No info */) {
    ...
    //     0x1ec3f4: ldr             x2, [PP, #0x7af0]  ; [pp+0x7af0] Closure: (_RouteEntry) => bool from Function 'isPresentPredicate': static. (0x7fa9a78b2ea8)
    // 0x1ec3f8: r0 = where()
  ...
  _ didStartUserGesture(/* No info */) {
    ...
    //     0x1ef134: ldr             x3, [PP, #0x7b08]  ; [pp+0x7b08] Closure: (_RouteEntry) => bool from Function 'willBePresentPredicate': static. (0x7fa9a78b2e70)
    ...
    //     0x1ef198: ldr             x3, [PP, #0x7b08]  ; [pp+0x7b08] Closure: (_RouteEntry) => bool from Function 'willBePresentPredicate': static. (0x7fa9a78b2e70)
  ...
  _ _recordLastFocus(/* No info */) {
    ...
    //     0x23f614: ldr             x2, [PP, #0x7af0]  ; [pp+0x7af0] Closure: (_RouteEntry) => bool from Function 'isPresentPredicate': static. (0x7fa9a78b2ea8)
    // 0x23f618: r0 = where()
