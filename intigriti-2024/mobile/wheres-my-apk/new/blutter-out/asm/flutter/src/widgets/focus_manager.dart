...
class FocusNode extends _FocusNode&Object&DiagnosticableTreeMixin&ChangeNotifier {
  ...
  _ unfocus(/* No info */) {
    ...
    //     0x1f03dc: ldr             x2, [PP, #0x5078]  ; [pp+0x5078] Closure: (FocusNode) => bool from Function '_allowDescendantsToBeFocused@99042876': static. (0x7fa9a78ba818)
    // 0x1f03e0: r0 = every()
    ...
    //     0x1f0514: ldr             x2, [PP, #0x5078]  ; [pp+0x5078] Closure: (FocusNode) => bool from Function '_allowDescendantsToBeFocused@99042876': static. (0x7fa9a78ba818)
    // 0x1f0518: r0 = every()
  ...
  get _ canRequestFocus(/* No info */) {
    ...
    //     0x1f08bc: ldr             x2, [PP, #0x5078]  ; [pp+0x5078] Closure: (FocusNode) => bool from Function '_allowDescendantsToBeFocused@99042876': static. (0x7fa9a78ba818)
    // 0x1f08c0: r0 = every()
...
class FocusScopeNode extends FocusNode {
  ...
  _ _doRequestFocus(/* No info */) {
    ...
    //     0x33a9d0: ldr             x2, [PP, #0x5078]  ; [pp+0x5078] Closure: (FocusNode) => bool from Function '_allowDescendantsToBeFocused@99042876': static. (0x7fa9a78ba818)
    // 0x33a9d4: r0 = every()
