...
class _WidgetsAppState extends __WidgetsAppState&State&WidgetsBindingObserver {
  ...
  _ build(/* No info */) {
    ...
    //     0x1df010: add             x0, PP, #0xb, lsl #12  ; [pp+0xba30] Closure: (NavigatorState, String) => List<Route<dynamic>> from Function 'defaultGenerateInitialRoutes': static. (0x7fa9a78aa37c)
    ...
    //     0x1df20c: ldr             x0, [PP, #0x6aa0]  ; [pp+0x6aa0] Closure: (FocusNode, {ScrollPositionAlignmentPolicy? alignmentPolicy, double? alignment, Duration? duration, Curve? curve}) => void from Function 'defaultTraversalRequestFocusCallback': static. (0x7fa9a78b33b8)
