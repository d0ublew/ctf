...
class :: {
  ...
  static void _debugPrintTask() {
    ...
    //     0x19c17c: ldr             x3, [PP, #0x488]  ; [pp+0x488] Closure: () => void from Function '_debugPrintTask@31110992': static. (0x7fa9a7866280)
    // 0x19c180: r0 = Timer()
  ...
  static (dynamic, String?, {int? wrapWidth}) => void debugPrint() {
    ...
    //     0x1a1448: ldr             x0, [PP, #0x1140]  ; [pp+0x1140] Closure: (String?, {int? wrapWidth}) => void from Function 'debugPrintThrottled': static. (0x7fa9a7865de8)
    // 0x1a144c: ret
    //     0x1a144c: ret             
  }
}
