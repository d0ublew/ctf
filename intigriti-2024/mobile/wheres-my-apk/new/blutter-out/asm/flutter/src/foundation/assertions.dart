...
class FlutterError extends _FlutterError&Error&DiagnosticableTreeMixin
  ...
  static (dynamic, StackTrace) => StackTrace demangleStackTrace() {
    ...
    //     0x1a1440: ldr             x0, [PP, #0x1138]  ; [pp+0x1138] Closure: (StackTrace) => StackTrace from Function '_defaultStackTraceDemangler@19022608': static. (0x7fa9a7a228b8)
    // 0x1a1444: ret
    //     0x1a1444: ret             
  }
  static ((dynamic, FlutterErrorDetails) => void)? onError() {
    ...
    //     0x1a1480: ldr             x0, [PP, #0x1150]  ; [pp+0x1150] Closure: (FlutterErrorDetails, {bool forceReport}) => void from Function 'dumpErrorToConsole': static. (0x7fa9a7865bcc)
    // 0x1a1484: LeaveFrame
    //     0x1a1484: mov             SP, fp
  ...
  static (dynamic, FlutterErrorDetails) => void presentError() {
    ...
    //     0x1a1498: ldr             x0, [PP, #0x1150]  ; [pp+0x1150] Closure: (FlutterErrorDetails, {bool forceReport}) => void from Function 'dumpErrorToConsole': static. (0x7fa9a7865bcc)
    // 0x1a149c: ret
    //     0x1a149c: ret             
  }
  _ toString(/* No info */) {
