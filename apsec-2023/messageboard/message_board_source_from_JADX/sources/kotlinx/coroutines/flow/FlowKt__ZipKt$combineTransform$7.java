...
@Metadata(mo15831d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0006\b\u0000\u0010\u0002\u0018\u0001\"\u0004\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u0004H@"}, mo15832d2 = {"<anonymous>", "", "T", "R", "Lkotlinx/coroutines/flow/FlowCollector;"}, mo15833k = 3, mo15834mv = {1, 6, 0}, mo15836xi = 176)
@DebugMetadata(mo16546c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7", mo16547f = "Zip.kt", mo16548i = {}, mo16549l = {308}, mo16550m = "invokeSuspend", mo16551n = {}, mo16552s = {})
...
public final class FlowKt__ZipKt$combineTransform$7 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    @Metadata(mo15831d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\u0010\u0000\u001a\u00020\u0001\"\u0006\b\u0000\u0010\u0002\u0018\u0001\"\u0004\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0006H@"}, mo15832d2 = {"<anonymous>", "", "T", "R", "Lkotlinx/coroutines/flow/FlowCollector;", "it", ""}, mo15833k = 3, mo15834mv = {1, 6, 0}, mo15836xi = 176)
    @DebugMetadata(mo16546c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2", mo16547f = "Zip.kt", mo16548i = {}, mo16549l = {308}, mo16550m = "invokeSuspend", mo16551n = {}, mo16552s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2 */
    /* compiled from: Zip.kt */
    public static final class C09712 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        /* synthetic */ Object L$1;
        int label;

        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C09712 r0 = new C09712(r3, continuation);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            }, new C09712((Continuation<? super C09712>) null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i == 1) {
            ResultKt.throwOnFailure(obj);
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        }, new C09712((Continuation<? super C09712>) null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
