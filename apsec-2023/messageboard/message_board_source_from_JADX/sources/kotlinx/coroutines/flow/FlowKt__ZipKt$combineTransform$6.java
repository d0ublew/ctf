...
@DebugMetadata(mo16546c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6", mo16547f = "Zip.kt", mo16548i = {}, mo16549l = {251}, mo16550m = "invokeSuspend", mo16551n = {}, mo16552s = {})
...
public final class FlowKt__ZipKt$combineTransform$6 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(mo16546c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2", mo16547f = "Zip.kt", mo16548i = {}, mo16549l = {251}, mo16550m = "invokeSuspend", mo16551n = {}, mo16552s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2 */
    /* compiled from: Zip.kt */
    public static final class C09692 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        /* synthetic */ Object L$1;
        int label;

        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C09692 r0 = new C09692(r3, continuation);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            }, new C09692((Continuation<? super C09692>) null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i == 1) {
            ResultKt.throwOnFailure(obj);
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        }, new C09692((Continuation<? super C09692>) null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
