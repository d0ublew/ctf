    ...
    public final CancellableContinuationImpl<T> claimReusableCancellableContinuation() {
        while (true) {
            ...
            if (obj == null) {
                ...
                if (ConcurrentWeakMap$Core$$ExternalSyntheticBackportWithForwarding0.m119m(_reusableCancellableContinuation$FU, (Object) this, obj, (Object) DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                    return (CancellableContinuationImpl) obj;
                }
        ...
        do {
            ...
            if (obj != DispatchedContinuationKt.REUSABLE_CLAIMED) {
                if (!(obj instanceof Throwable)) {
                    throw new IllegalStateException(Intrinsics.stringPlus("Inconsistent state ", obj).toString());
                } else if (ConcurrentWeakMap$Core$$ExternalSyntheticBackportWithForwarding0.m119m(_reusableCancellableContinuation$FU, (Object) this, obj, (Object) null)) {
                    return (Throwable) obj;
                } else {
                    throw new IllegalArgumentException("Failed requirement.".toString());
                }
            }
        } while (!ConcurrentWeakMap$Core$$ExternalSyntheticBackportWithForwarding0.m119m(_reusableCancellableContinuation$FU, (Object) this, (Object) DispatchedContinuationKt.REUSABLE_CLAIMED, (Object) cancellableContinuation));
        return null;
    }
    ...
    public final boolean postponeCancellation(Throwable th) {
        while (true) {
            ...
            if (Intrinsics.areEqual(obj, (Object) DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                if (ConcurrentWeakMap$Core$$ExternalSyntheticBackportWithForwarding0.m119m(_reusableCancellableContinuation$FU, (Object) this, (Object) DispatchedContinuationKt.REUSABLE_CLAIMED, (Object) th)) {
                    return true;
                }
            } else if (obj instanceof Throwable) {
                return true;
            } else {
                if (ConcurrentWeakMap$Core$$ExternalSyntheticBackportWithForwarding0.m119m(_reusableCancellableContinuation$FU, (Object) this, obj, (Object) null)) {
                    return false;
                }
            }
        }
