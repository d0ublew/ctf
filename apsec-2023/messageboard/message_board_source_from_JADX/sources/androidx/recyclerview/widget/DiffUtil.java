    ...
    public static class DiffResult {
        ...
        private boolean findMatchingItem(int i, int i2, int i3, boolean z) {
            ...
            while (i3 >= 0) {
                ...
                int i6 = snake.f92x + snake.size;
                int i7 = snake.f93y + snake.size;
                int i8 = 8;
                if (z) {
        ...
        public void dispatchUpdatesTo(ListUpdateCallback listUpdateCallback) {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                Snake snake = this.mSnakes.get(size);
                int i3 = snake.size;
                int i4 = snake.f92x + i3;
                int i5 = snake.f93y + i3;
                if (i4 < i) {
                ...
                for (int i6 = i3 - 1; i6 >= 0; i6--) {
                    if ((this.mOldItemStatuses[snake.f92x + i6] & 31) == 2) {
                        batchingListUpdateCallback.onChanged(snake.f92x + i6, 1, this.mCallback.getChangePayload(snake.f92x + i6, snake.f93y + i6));
                    }
                }
                i = snake.f92x;
                i2 = snake.f93y;
