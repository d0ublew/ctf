...
public class FlexBuffersBuilder {
    ...
    /* renamed from: bb */
    public final ReadWriteBuf f86bb;
    ...
    public FlexBuffersBuilder(ReadWriteBuf readWriteBuf, int i) {
        ...
        this.keyComparator = new Comparator<Value>() {
            public int compare(Value value, Value value2) {
                ...
                int i2 = value2.key;
                do {
                    b = FlexBuffersBuilder.this.f86bb.get(i);
                    b2 = FlexBuffersBuilder.this.f86bb.get(i2);
                    if (b == 0) {
                        return b - b2;
                    }
                    i++;
    ...
    private int align(int i) {
        int i2 = 1 << i;
        int access$100 = Value.paddingBytes(this.f86bb.writePosition(), i2);
        while (true) {
            int i3 = access$100 - 1;
            if (access$100 == 0) {
                return i2;
    ...
    private void writeInt(long j, int i) {
        if (i == 1) {
            this.f86bb.put((byte) ((int) j));
        } else if (i == 2) {
            this.f86bb.putShort((short) ((int) j));
        } else if (i == 4) {
    ...
    private Value createVector(int i, int i2, int i3, boolean z, boolean z2, Value value) {
        ...
        if (value2 != null) {
            max = Math.max(max, value2.elemWidth(this.f86bb.writePosition(), 0));
            i4 = 3;
        } else {
            i4 = 1;
        }
        ...
        if (!z) {
            while (i11 < this.stack.size()) {
                this.f86bb.put(this.stack.get(i11).storedPackedType(i8));
                i11++;
            }
        }
        if (value2 != null) {
    ...
    private void writeOffset(long j, int i) {
        writeInt((long) ((int) (((long) this.f86bb.writePosition()) - j)), i);
    }
    ...
    private Value createKeyVector(int i, int i2) {
        ...
        while (i3 < this.stack.size()) {
            i3++;
            max = Math.max(max, Value.elemWidth(4, 0, (long) this.stack.get(i3).key, this.f86bb.writePosition(), i3));
        }
        int align = align(max);
        writeInt(j, align);
        int writePosition = this.f86bb.writePosition();
