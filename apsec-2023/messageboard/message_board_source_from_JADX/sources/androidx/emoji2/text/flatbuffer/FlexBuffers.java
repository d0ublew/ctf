...
public class FlexBuffers {
    ...
    public static class Reference {
        ...
        public long asUInt() {
            ...
            if (i == 26) {
                return (long) FlexBuffers.readInt(this.f85bb, this.end, this.parentWidth);
            }
            if (i == 5) {
        ...
        public double asFloat() {
            ...
            if (i == 1) {
                return (double) FlexBuffers.readInt(this.f85bb, this.end, this.parentWidth);
            }
            if (i != 2) {
                if (i == 5) {
            ...
            return (double) FlexBuffers.readUInt(this.f85bb, this.end, this.parentWidth);
        }
        ...
        public String asString() {
            if (isString()) {
                int access$200 = FlexBuffers.indirect(this.f85bb, this.end, this.parentWidth);
                ReadBuf readBuf = this.f85bb;
                int i = this.byteWidth;
                return this.f85bb.getString(access$200, (int) FlexBuffers.readUInt(readBuf, access$200 - i, i));
            } else if (!isKey()) {
                return "";
            } else {
                int access$2002 = FlexBuffers.indirect(this.f85bb, this.end, this.byteWidth);
                int i2 = access$2002;
                while (this.f85bb.get(i2) != 0) {
                    i2++;
                }
                return this.f85bb.getString(access$2002, i2 - access$2002);
            }
        }
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int i) {
            ...
            int byteToUnsignedInt = Unsigned.byteToUnsignedInt(this.f84bb.get((int) (((long) this.end) + (size * ((long) this.byteWidth)) + j)));
            return new Reference(this.f84bb, this.end + (i * this.byteWidth), this.byteWidth, byteToUnsignedInt);
        }
    }
