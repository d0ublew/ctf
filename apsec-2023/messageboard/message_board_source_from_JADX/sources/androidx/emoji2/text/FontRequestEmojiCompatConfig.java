    ...
    private static class FontRequestMetadataLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        public void loadInternal() {
            synchronized (this.mLock) {
                if (this.mCallback != null) {
                    ...
                    this.mExecutor.execute(new C0293xc2d47b97(this));
                }
            }
        }
        ...
        private void scheduleRetry(Uri uri, long j) {
            synchronized (this.mLock) {
                ...
                if (this.mObserver == null) {
                    C02921 r2 = new ContentObserver(handler) {
                ...
                if (this.mMainHandlerLoadCallback == null) {
                    this.mMainHandlerLoadCallback = new C0294xc2d47b98(this);
                }
        ...
        public void createMetadata() {
            ...
            L_0x0036:
                ...
                androidx.core.p003os.TraceCompat.beginSection(r0)     // Catch:{ all -> 0x0075 }
                ...
                androidx.core.p003os.TraceCompat.endSection()     // Catch:{ all -> 0x0093 }
