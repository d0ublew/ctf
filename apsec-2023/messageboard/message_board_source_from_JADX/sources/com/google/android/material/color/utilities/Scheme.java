...
public class Scheme {
    ...
    public static Scheme light(int i) {
        return lightFromCorePalette(CorePalette.m55of(i));
    }

    public static Scheme dark(int i) {
        return darkFromCorePalette(CorePalette.m55of(i));
    }
    ...
    private static Scheme lightFromCorePalette(CorePalette corePalette) {
        return new Scheme().withPrimary(corePalette.f172a1.tone(40)).withOnPrimary(corePalette.f172a1.tone(100)).withPrimaryContainer(corePalette.f172a1.tone(90)).withOnPrimaryContainer(corePalette.f172a1.tone(10)).withSecondary(corePalette.f173a2.tone(40)).withOnSecondary(corePalette.f173a2.tone(100)).withSecondaryContainer(corePalette.f173a2.tone(90)).withOnSecondaryContainer(corePalette.f173a2.tone(10)).withTertiary(corePalette.f174a3.tone(40)).withOnTertiary(corePalette.f174a3.tone(100)).withTertiaryContainer(corePalette.f174a3.tone(90)).withOnTertiaryContainer(corePalette.f174a3.tone(10)).withError(corePalette.error.tone(40)).withOnError(corePalette.error.tone(100)).withErrorContainer(corePalette.error.tone(90)).withOnErrorContainer(corePalette.error.tone(10)).withBackground(corePalette.f175n1.tone(99)).withOnBackground(corePalette.f175n1.tone(10)).withSurface(corePalette.f175n1.tone(99)).withOnSurface(corePalette.f175n1.tone(10)).withSurfaceVariant(corePalette.f176n2.tone(90)).withOnSurfaceVariant(corePalette.f176n2.tone(30)).withOutline(corePalette.f176n2.tone(50)).withOutlineVariant(corePalette.f176n2.tone(80)).withShadow(corePalette.f175n1.tone(0)).withScrim(corePalette.f175n1.tone(0)).withInverseSurface(corePalette.f175n1.tone(20)).withInverseOnSurface(corePalette.f175n1.tone(95)).withInversePrimary(corePalette.f172a1.tone(80));
    }

    private static Scheme darkFromCorePalette(CorePalette corePalette) {
        return new Scheme().withPrimary(corePalette.f172a1.tone(80)).withOnPrimary(corePalette.f172a1.tone(20)).withPrimaryContainer(corePalette.f172a1.tone(30)).withOnPrimaryContainer(corePalette.f172a1.tone(90)).withSecondary(corePalette.f173a2.tone(80)).withOnSecondary(corePalette.f173a2.tone(20)).withSecondaryContainer(corePalette.f173a2.tone(30)).withOnSecondaryContainer(corePalette.f173a2.tone(90)).withTertiary(corePalette.f174a3.tone(80)).withOnTertiary(corePalette.f174a3.tone(20)).withTertiaryContainer(corePalette.f174a3.tone(30)).withOnTertiaryContainer(corePalette.f174a3.tone(90)).withError(corePalette.error.tone(80)).withOnError(corePalette.error.tone(20)).withErrorContainer(corePalette.error.tone(30)).withOnErrorContainer(corePalette.error.tone(80)).withBackground(corePalette.f175n1.tone(10)).withOnBackground(corePalette.f175n1.tone(90)).withSurface(corePalette.f175n1.tone(10)).withOnSurface(corePalette.f175n1.tone(90)).withSurfaceVariant(corePalette.f176n2.tone(30)).withOnSurfaceVariant(corePalette.f176n2.tone(80)).withOutline(corePalette.f176n2.tone(60)).withOutlineVariant(corePalette.f176n2.tone(30)).withShadow(corePalette.f175n1.tone(0)).withScrim(corePalette.f175n1.tone(0)).withInverseSurface(corePalette.f175n1.tone(90)).withInverseOnSurface(corePalette.f175n1.tone(20)).withInversePrimary(corePalette.f172a1.tone(40));
    }
