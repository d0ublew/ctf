...
class ClearTextEndIconDelegate extends EndIconDelegate {
    ...
    public /* synthetic */ void mo14964xfc81bd94(View view) {
    ...
    public /* synthetic */ void mo14965x7ae2c173(View view, boolean z) {
        animateIcon(shouldBeVisible());
    }

    ClearTextEndIconDelegate(EndCompoundLayout endCompoundLayout) {
        super(endCompoundLayout);
        this.animationFadeDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), C0573R.attr.motionDurationShort3, 100);
        this.animationScaleDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), C0573R.attr.motionDurationShort3, DEFAULT_ANIMATION_SCALE_DURATION);
        this.animationFadeInterpolator = MotionUtils.resolveThemeInterpolator(endCompoundLayout.getContext(), C0573R.attr.motionEasingLinearInterpolator, AnimationUtils.LINEAR_INTERPOLATOR);
        this.animationScaleInterpolator = MotionUtils.resolveThemeInterpolator(endCompoundLayout.getContext(), C0573R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
    }
    ...
    public /* synthetic */ void mo14966x26d8c5f4() {
        animateIcon(true);
    }

    /* access modifiers changed from: package-private */
    public int getIconDrawableResId() {
        return C0573R.C0575drawable.mtrl_ic_cancel;
    }

    /* access modifiers changed from: package-private */
    public int getIconContentDescriptionResId() {
        return C0573R.string.clear_text_end_icon_content_description;
    }
    ...
    public /* synthetic */ void mo14962xa5c23ba8(ValueAnimator valueAnimator) {
    ...
    public /* synthetic */ void mo14963x3819711b(ValueAnimator valueAnimator) {
