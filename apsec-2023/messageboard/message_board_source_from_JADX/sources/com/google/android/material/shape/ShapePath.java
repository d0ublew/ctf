...
public class ShapePath {
    ...
    public void lineTo(float f, float f2) {
        ...
        float unused = pathLineOperation.f193x = f;
        float unused2 = pathLineOperation.f194y = f2;
    ...
    public void lineTo(float f, float f2, float f3, float f4) {
        if ((Math.abs(f - getEndX()) >= 0.001f || Math.abs(f2 - getEndY()) >= 0.001f) && (Math.abs(f - f3) >= 0.001f || Math.abs(f2 - f4) >= 0.001f)) {
            ...
            float unused3 = pathLineOperation2.f193x = f3;
            float unused4 = pathLineOperation2.f194y = f4;
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot((double) (this.operation.f194y - this.startY), (double) (this.operation.f193x - this.startX)), 0.0f);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((double) ((this.operation.f194y - this.startY) / (this.operation.f193x - this.startX))));
        }
    }
    ...
    static class InnerCornerShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            ...
            if (sweepAngle <= 0.0f) {
                double hypot = Math.hypot((double) (this.operation1.f193x - this.startX), (double) (this.operation1.f194y - this.startY));
                double hypot2 = Math.hypot((double) (this.operation2.f193x - this.operation1.f193x), (double) (this.operation2.f194y - this.operation1.f194y));
        ...
        public float getStartAngle() {
            return (float) Math.toDegrees(Math.atan((double) ((this.operation1.f194y - this.startY) / (this.operation1.f193x - this.startX))));
        }

        /* access modifiers changed from: package-private */
        public float getEndAngle() {
            return (float) Math.toDegrees(Math.atan((double) ((this.operation2.f194y - this.operation1.f194y) / (this.operation2.f193x - this.operation1.f193x))));
        }
