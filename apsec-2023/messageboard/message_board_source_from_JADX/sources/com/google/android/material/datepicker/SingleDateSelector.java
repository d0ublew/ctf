...
public class SingleDateSelector implements DateSelector<Long> {
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints calendarConstraints, OnSelectionChangedListener<Long> onSelectionChangedListener) {
        String str;
        View inflate = layoutInflater.inflate(C0573R.layout.mtrl_picker_text_input_date, viewGroup, false);
        final TextInputLayout textInputLayout = (TextInputLayout) inflate.findViewById(C0573R.C0576id.mtrl_picker_text_input_date);
    ...
    public int getDefaultThemeResId(Context context) {
        return MaterialAttributes.resolveOrThrow(context, C0573R.attr.materialCalendarTheme, MaterialDatePicker.class.getCanonicalName());
    }
    ...
    public String getSelectionDisplayString(Context context) {
        ...
        Long l = this.selectedItem;
        if (l == null) {
            return resources.getString(C0573R.string.mtrl_picker_date_header_unselected);
        }
        String yearMonthDay = DateStrings.getYearMonthDay(l.longValue());
        return resources.getString(C0573R.string.mtrl_picker_date_header_selected, new Object[]{yearMonthDay});
    }
    ...
    public String getSelectionContentDescription(Context context) {
        ...
        return resources.getString(C0573R.string.mtrl_picker_announce_current_selection, new Object[]{str});
    }
    ...
    public int getDefaultTitleResId() {
        return C0573R.string.mtrl_picker_date_header_title;
    }
