...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
    ...
    public int getDefaultThemeResId(Context context) {
        ...
        if (Math.min(displayMetrics.widthPixels, displayMetrics.heightPixels) > resources.getDimensionPixelSize(C0573R.dimen.mtrl_calendar_maximum_default_fullscreen_minor_axis)) {
            i = C0573R.attr.materialCalendarTheme;
        } else {
            i = C0573R.attr.materialCalendarFullscreenTheme;
        }
    ...
    public String getSelectionDisplayString(Context context) {
        ...
        if (l == null && this.selectedEndItem == null) {
            return resources.getString(C0573R.string.mtrl_picker_range_header_unselected);
        }
        Long l2 = this.selectedEndItem;
        if (l2 == null) {
            return resources.getString(C0573R.string.mtrl_picker_range_header_only_start_selected, new Object[]{DateStrings.getDateString(this.selectedStartItem.longValue())});
        } else if (l == null) {
            return resources.getString(C0573R.string.mtrl_picker_range_header_only_end_selected, new Object[]{DateStrings.getDateString(this.selectedEndItem.longValue())});
        } else {
            Pair<String, String> dateRangeString = DateStrings.getDateRangeString(l, l2);
            return resources.getString(C0573R.string.mtrl_picker_range_header_selected, new Object[]{dateRangeString.first, dateRangeString.second});
        }
    }
    ...
    public String getSelectionContentDescription(Context context) {
        ...
        if (dateRangeString.first == null) {
            str = resources.getString(C0573R.string.mtrl_picker_announce_current_selection_none);
        } else {
            str = (String) dateRangeString.first;
        }
        if (dateRangeString.second == null) {
            str2 = resources.getString(C0573R.string.mtrl_picker_announce_current_selection_none);
        } else {
            str2 = (String) dateRangeString.second;
        }
        return resources.getString(C0573R.string.mtrl_picker_announce_current_range_selection, new Object[]{str, str2});
    }
    ...
    public int getDefaultTitleResId() {
        return C0573R.string.mtrl_picker_range_header_title;
    }
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints calendarConstraints, OnSelectionChangedListener<Pair<Long, Long>> onSelectionChangedListener) {
        String str;
        View inflate = layoutInflater.inflate(C0573R.layout.mtrl_picker_text_input_date_range, viewGroup, false);
        TextInputLayout textInputLayout = (TextInputLayout) inflate.findViewById(C0573R.C0576id.mtrl_picker_text_input_range_start);
        TextInputLayout textInputLayout2 = (TextInputLayout) inflate.findViewById(C0573R.C0576id.mtrl_picker_text_input_range_end);
        ...
        this.invalidRangeStartError = inflate.getResources().getString(C0573R.string.mtrl_picker_invalid_range);
        ...
        C06761 r0 = new DateFormatTextWatcher(str2, simpleDateFormat2, textInputLayout, calendarConstraints2) {
