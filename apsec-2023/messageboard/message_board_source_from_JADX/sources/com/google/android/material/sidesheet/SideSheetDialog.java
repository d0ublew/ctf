...
public class SideSheetDialog extends SheetDialog<SideSheetCallback> {
    private static final int SIDE_SHEET_DIALOG_DEFAULT_THEME_RES = C0573R.style.Theme_Material3_Light_SideSheetDialog;
    private static final int SIDE_SHEET_DIALOG_THEME_ATTR = C0573R.attr.sideSheetDialogTheme;
    ...
    public int getLayoutResId() {
        return C0573R.layout.m3_side_sheet_dialog;
    }

    /* access modifiers changed from: package-private */
    public int getDialogId() {
        return C0573R.C0576id.m3_side_sheet;
    }
