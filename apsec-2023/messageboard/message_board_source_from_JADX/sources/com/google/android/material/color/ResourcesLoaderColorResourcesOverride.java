...
class ResourcesLoaderColorResourcesOverride implements ColorResourcesOverride {
    ...
    public boolean applyIfPossible(Context context, Map<Integer, Integer> map) {
        ...
        ThemeUtils.applyThemeOverlay(context, C0573R.style.ThemeOverlay_Material3_PersonalizedColors);
        return true;
    }

    public Context wrapContextIfPossible(Context context, Map<Integer, Integer> map) {
        ContextThemeWrapper contextThemeWrapper = new ContextThemeWrapper(context, C0573R.style.ThemeOverlay_Material3_PersonalizedColors);
